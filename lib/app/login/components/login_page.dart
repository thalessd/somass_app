      ...
      body: Container(
        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Expanded(
                      child: Center(
                        child: LoginForm(onSubmit: this.onSubmit, load: this.load),
                      ),
                    ),
                    Container(
            ...
            if(load) LinearProgressIndicator(minHeight: 8, backgroundColor: Theme.of(context).accentColor.withOpacity(0.4),)
          ],
        ),
      ),
    );
