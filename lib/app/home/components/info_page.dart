    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          ListTile(
            onTap: () {
              launch("https://api.whatsapp.com/send?phone=5589999889460");
            },
          ...
          ListTile(
            onTap: () {
              launch("https://instagram.com/devdes.io");
            },
          ...
          Text(
            ...
            " de ajudar no periodo da pandemia, para que todos possam"
            " marcar o melhor horário e dia da semana para "
            "participar da missa, eliminando a necessidade de entrar em "
            "contato via mensagem de texto e afins, assim respeitando as "
            "medidas de distânciamento.",
          ...
          Text(
            "Obrigado por baixar nosso aplicativo!",
